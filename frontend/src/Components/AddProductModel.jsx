			...
			<Modal.Body>
				<Form onSubmit={handleSubmit}>
					...
					<Form.Group className="mb-3">
						...
						{previewImage ? (
							<div>
								<img src={previewImage} alt="Preview" className="img-thumbnail mb-2" style={{ height: '150px', width: '150px', objectFit: 'cover' }} />
								<Button
									variant="link"
									onClick={() => {
							...
							<div className="border border-dashed p-3 text-center">
								<Form.Label htmlFor="image-upload" className="d-block cursor-pointer">
									<svg
										className="mb-2"
										width="40"
										height="40"
...
// import axios from 'axios';
// 	const apiUrl = import.meta.env.VITE_API_BASE_URL;
// const AddProductModel = ({ isOpen, onClose, setProducts }) => {
// 	const [formData, setFormData] = useState({
// 		name: '',
// 		price: '',
// 		description: '',
